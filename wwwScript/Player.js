...
Player.prototype.update = function(timestampDelta, timestamp) {
  ...
  // boundary checks
  if (this.position.x < IMAGE_SIZE/2) { this.position.x = IMAGE_SIZE/2; }
  if (this.position.x > CANVAS_WIDTH - IMAGE_SIZE/2) { this.position.x = CANVAS_WIDTH - IMAGE_SIZE/2; }
  if (this.position.y < IMAGE_SIZE/2) { this.position.y = IMAGE_SIZE/2; }
  if (this.position.y > CANVAS_HEIGHT - IMAGE_SIZE/2) { this.position.y = CANVAS_HEIGHT - IMAGE_SIZE/2; }
}
